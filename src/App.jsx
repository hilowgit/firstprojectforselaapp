...
const Header = ({ onMenuToggle }) => {
  return (
    <header className="fixed top-0 right-0 left-0 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm shadow-md h-16 z-40 flex items-center justify-between px-4">
      <h1 className="text-xl font-bold text-blue-700 dark:text-blue-400">المركز التعليمي</h1>
...
const SideMenu = ({ isOpen, onClose, theme, setTheme }) => {
  ...
  return (
    <>
      ...
      <aside 
        className="fixed top-0 right-0 bottom-0 w-72 bg-gray-50 dark:bg-gray-800 shadow-2xl z-50 transition-transform duration-300 ease-in-out"
      ...
      >
        <div className="p-4">
          ...
          <ul>
            <li>
              <button onClick={toggleTheme} className="w-full flex items-center gap-4 p-3 rounded-lg text-lg text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700">
                {theme === 'dark' ? 
...
export default function App() {
  ...
  return (
    <div className="bg-gray-100 dark:bg-gray-900 min-h-screen text-gray-800 dark:text-gray-200 font-['Cairo',_sans-serif] transition-colors duration-300">
